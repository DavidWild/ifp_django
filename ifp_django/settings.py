...
# This is the webfactional server version of this file
...
if IS_WEBFACTION:
    ADMINS = (
         #('David Wild', 'davidgwild1970@gmail.com'),
        ('dgwadmin', 'davidgwild1970@gmail.com')
    )
else:
    ADMINS = (
         ('dgwadmin', 'davidgwild1970@gmail.com'),
...
if IS_WEBFACTION :
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'intelligent_exam_papers_20131029',                      # Or path to database file if using sqlite3.
    ...
    # DATABSE SETTINGS for local development
    DATABASES = {
        'default': {
            #'ENGINE': 'django.db.backends.postgresql_psycopg2', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
...
ALLOWED_HOSTS = ['davidgwild.webfactional.com','localhost']
...
if IS_WEBFACTION:
    MEDIA_URL = '/home/davidgwild/webapps/images/'
else:
...
if IS_WEBFACTION:
    ...
    STATIC_ROOT = '/Applications/MAMP/htdocs/IFP_static/'
...
if IS_WEBFACTION:
    ...
    PDFLOCATION = '/Library/WebServer/Documents/pdfs/'

if IS_WEBFACTION:
    PDFURL = 'http://davidgwild.webfactional.com/pdfs/'
else:
    PDFURL = 'http://127.0.0.1/pdfs/'
